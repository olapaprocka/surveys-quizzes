...
import pl.paprocka.surveysquizzes.config.Roles;


import java.util.Arrays;

import static pl.paprocka.surveysquizzes.config.Roles.ADMIN;
import static pl.paprocka.surveysquizzes.config.Roles.USER;
